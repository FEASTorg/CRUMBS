...
int main(void)
{
    ...
    if (CRUMBS_VERSION_MINOR != 9)
    {
        fprintf(stderr, "FAIL: Expected MINOR=9, got %d\n", CRUMBS_VERSION_MINOR);
        return 1;
    }
    
    if (CRUMBS_VERSION_PATCH != 5)
    {
        fprintf(stderr, "FAIL: Expected PATCH=5, got %d\n", CRUMBS_VERSION_PATCH);
        return 1;
    }
    ...
    if (strcmp(CRUMBS_VERSION_STRING, "0.9.5") != 0)
    {
        fprintf(stderr, "FAIL: Expected version string '0.9.5', got '%s'\n", 
